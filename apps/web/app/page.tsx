...
function MkProof() {
  const principles = [
    ...
    { kicker: '02', title: 'One flat rate', body: 'One rate per organization. The bill stays the same on a slow Tuesday and a packed Saturday.' },
...
function MkPricing() {
  ...
  const plans: Plan[] = [
    ...
    },
    {
      ...
      features: [
        'Unlimited contacts',
        '25,000 appointments / month',
        '150 events / month',
        'Email verification',
        'Event ticket payments',
        'Visitor memberships & subscriptions',
        'Priority support',
      ],
    },
  ];
